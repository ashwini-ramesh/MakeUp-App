 ...
 */
public class MaterialSearchViewFragment extends FrameLayout implements Filter.FilterListener {
    ...
    public MaterialSearchViewFragment(Context context) {
        this(context, null);
    }

    public MaterialSearchViewFragment(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MaterialSearchViewFragment(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs);
    ...
    private void initiateView() {
        LayoutInflater.from(mContext).inflate(R.layout.search_view_another, this, true);
    ...
    private void initSearchView() {
        ...
        mSearchSrcTextView.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                mUserQuery = s;
                startFilter(s);
                MaterialSearchViewFragment.this.onTextChanged(s);
            }
    ...
    private void startFilter(CharSequence s) {
        if (mAdapter != null && mAdapter instanceof Filterable) {
            ((Filterable) mAdapter).getFilter().filter(s, MaterialSearchViewFragment.this);
        }
    }
    ...
    private void onVoiceClicked() {
        ...
        //intent.putExtra(RecognizerIntent.EXTRA_PROMPT, "Speak an ItemLabel name or number");    // user hint
    ...
    /**
     * Submit the query as soon as the user clicks the ItemLabel.
     *
   ...
   /* public void setSuggestions(String[] suggestions) {
    ...
    /**
     * Call this method and pass the menu ItemLabel so this class can handle click events for the Menu Item.
     *
     * @param menuItem
     */
